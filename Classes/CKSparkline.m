...
- (void)drawRect:(CGRect)rect {
	...
	CGContextMoveToPoint(context, 00.0, maxY);
	CGContextAddLineToPoint(context, 00.00, 00.0);
	CGContextMoveToPoint(context, 00.0, maxY);
	CGContextAddLineToPoint(context, maxX, maxY);
	//CGContextAddLineToPoint(context, maxX, 00.00);
	//CGContextAddLineToPoint(context, 00.00, 00.00);
